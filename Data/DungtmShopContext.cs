...
namespace duanwebsite.Data;

public partial class DungtmShopContext : DbContext
{
    public DungtmShopContext()
    {
    }

    public DungtmShopContext(DbContextOptions<DungtmShopContext> options)
        : base(options)
    {
    }
    ...
    //    => optionsBuilder.UseSqlServer("Data Source=DUNGTM;Initial Catalog=DungtmShop;Integrated Security=True;Encrypt=False");
