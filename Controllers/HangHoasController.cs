...
namespace duanwebsite.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(DungtmShopContext context)
        {
            _context = context;
        }
        ...
        {
            var dungtmShop = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await dungtmShop.ToListAsync());
        }
